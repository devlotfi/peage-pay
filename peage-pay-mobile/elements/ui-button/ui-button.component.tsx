...
import UIButtonContent from './ui-button-content.component';
import { AppTheme } from '../../theme/types/app-theme.type';
import { useAppTheme } from '../../hooks/use-app-theme.hook';
import UIButtonIcon from './ui-button-icon.component';
import { IconPosition, UIButtonContext, Variants } from './ui-button.context';
...
const UIButton = ({
  ...
  return (
    <UIButtonContext.Provider value={{ variant, iconPosition }}>
      <Pressable
        style={({ pressed }) => [
          styles.base,
          styles[variant],
...
UIButton.Content = UIButtonContent;
