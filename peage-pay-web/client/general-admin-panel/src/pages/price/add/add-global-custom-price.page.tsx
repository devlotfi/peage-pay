...
interface AddGlobalCustomPriceValues {
  value: number;
  priority: number;
...
const initialValues: AddGlobalCustomPriceValues = {
  value: 1,
  priority: 1,
  startTimestamp: '',
  endTimestamp: '',
...
const addGlobalCustomPriceValidationSchema = yup.object({
...
const AddGlobalCustomPricePage = (): JSX.Element => {
  ...
  const { errors, touched, handleChange, handleBlur, handleSubmit, values } =
    useFormik({
      initialValues,
      validationSchema: addGlobalCustomPriceValidationSchema,
      onSubmit(values) {
        addGlobalPrice({
          variables: {
            addPriceInput: {
      ...
      <FormPageLayout.Form onSubmit={handleSubmit}>
        <FormPageLayout.Title>
          <Heading className="text-[20pt]">
            ...
            <Heading.Text>{t('ADD_GLOBAL_CUSTOM_PRICE')}</Heading.Text>
          </Heading>
        </FormPageLayout.Title>
        ...
        <Button type="submit" variant={'primary'} className="mt-[0.5rem]">
          {loading ? (
            ...
            <>
              ...
              <Button.Content>{t('ADD_GLOBAL_CUSTOM_PRICE')}</Button.Content>
            </>
          )}
        </Button>
      </FormPageLayout.Form>
...
export default AddGlobalCustomPricePage;
