    ...
    <AdminDashboardLayout.Tabs>
      <Tabs className="mb-[1rem]">
        ...
        >
          ...
          <Tabs.Item.Content>{t('DAILY_PRICE_LOCAL_LIST')}</Tabs.Item.Content>
        </Tabs.Item>
        <Tabs.Item
        ...
        >
          ...
          <Tabs.Item.Content>{t('WEEKLY_PRICE_LOCAL_LIST')}</Tabs.Item.Content>
        </Tabs.Item>
        <Tabs.Item
        ...
        >
          ...
          <Tabs.Item.Content>{t('MONTHLY_PRICE_LOCAL_LIST')}</Tabs.Item.Content>
        </Tabs.Item>
        <Tabs.Item
        ...
        >
          ...
          <Tabs.Item.Content>{t('YEARLY_PRICE_LOCAL_LIST')}</Tabs.Item.Content>
        </Tabs.Item>
        <Tabs.Item
        ...
        >
          ...
          <Tabs.Item.Content>{t('CUSTOM_PRICE_LOCAL_LIST')}</Tabs.Item.Content>
        </Tabs.Item>
      </Tabs>
    </AdminDashboardLayout.Tabs>
  );
