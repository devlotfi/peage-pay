...
const initialValues: AddLocalDailyPriceValues = {
...
const addLocalDailyPriceValidationSchema = yup.object({
...
const AddLocalDailyPricePage = (): JSX.Element => {
  ...
  const { errors, touched, handleChange, handleBlur, handleSubmit, values } =
    useFormik({
      initialValues,
      validationSchema: addLocalDailyPriceValidationSchema,
      onSubmit(values) {
        addLocalPrice({
          variables: {
            addPriceInput: {
      ...
      <FormPageLayout.Form onSubmit={handleSubmit}>
        ...
        {data ? (
          <Alert variant={'success'} className="mb-[0.5rem]">
            ...
            <Alert.Content>Local daily price created</Alert.Content>
          </Alert>
        ) : null}
...
export default AddLocalDailyPricePage;
