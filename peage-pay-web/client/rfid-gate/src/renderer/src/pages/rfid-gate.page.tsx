...
import { faArrowDown, faInfo, faPrint } from '@fortawesome/free-solid-svg-icons'
...
import { START_TRIP_RFID } from '@renderer/graphql/mutations'
...
const RfidGatePage = (): JSX.Element => {
  ...
  const [generateTicket, { loading, error, data }] = useMutation(START_TRIP_RFID)
  ...
  const makePdf = () => {
    ...
    doc.text(`${automaticGateAuthData?.automaticGate.toll.name}`, docWidth / 2, 23, {
      align: 'center'
    })

    const imgWidth = 30
    const imgHeight = 30
    doc.addImage(imageData, 'WEBP', (docWidth - imgWidth) / 2, 30, imgWidth, imgHeight)
    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="flex flex-col flex-1 justify-center items-center">
        ...
        <div className="flex flex-col">
          <FontAwesomeIcon className="text-success-100" icon={faPrint} size="5x"></FontAwesomeIcon>
          <FontAwesomeIcon className="my-[1rem]" icon={faArrowDown} size="3x"></FontAwesomeIcon>
          <Button
