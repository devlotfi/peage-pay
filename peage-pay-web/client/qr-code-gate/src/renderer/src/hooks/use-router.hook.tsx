...
import QRCodeGatePage from '@renderer/pages/qr-code-gate.page'
import {
  ...
  const router = createHashRouter([
    ...
    },
    {
      ...
      element: notAuthGuard(
        <SignInAutomaticGatePage usage={'desktop'} title={t('APP_NAME')}></SignInAutomaticGatePage>
      )
    },
    {
      path: '/dashboard',
      ...
      children: [
        {
          path: '/dashboard',
          element: <QRCodeGatePage></QRCodeGatePage>
        }
      ]
    }
  ])
